...
// Explanation
// The first input represents the number of passed levels, -- in this case, 3 (the size of an array to be created). 
// The next 3 inputs are the points awarded to the player for passing each level. 
// The player gained 1+4+8 points for 3 passed levels, which is then output.
